            ...
            if (res.code == 1) {
                ...
                wx.ready(function () {
                    ...
                    wx.onMenuShareAppMessage({
                        ...
                        desc: courseContent,
                        link: 'https://m.xuexuele.vip/html/lessonDetail/lesson-share.html?courseId=' + courseId + "&uid=" + uid,
                        imgUrl: 'https://m.xuexuele.vip/images/04.png', // 分享图标
                        success: function () {
                            // alert(1);
                            shareNum(courseId);
                            // alert("success");
                    ...
                    wx.onMenuShareQQ({
                        ...
                        link: 'https://m.xuexuele.vip/html/lessonDetail/lesson-share.html?courseId=' + courseId + "&uid=" + uid, // 分享链接
                        imgUrl: 'https://m.xuexuele.vip/images/04.png', // 分享图标
                        success: function () {
                            shareNum(courseId);
                            // alert("success");
